...
- (void)viewDidLoad
{
    ...
    self.navigationItem.title = @"作ったレベル";
    self.navigationItem.prompt = @"レベルを選んで、または自分で作って(足すの記号を押して)";
...
- (void)preLoadData
{
    ...
    /*****************************************Scene 1***************************************************/
    if ([createdScene1.levelTitle isEqualToString:@"例1"]){
        NSLog(@"Found you");
    }
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"CreatedScene" inManagedObjectContext:self.managedObjectContext];
